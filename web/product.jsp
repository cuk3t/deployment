                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-body">		
                        <ul id="roomFilter">
                            <li class="sidebar-item" compid="opt" posid="0">			
                                <a class="sidebar-item-label_12" href="ShowListProductServlet?txtCategoryName=Kitchen">
                                    <span class="option-text">Kitchen</span>
                                </a>
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="1">			
                                <a class="sidebar-item-label_12" href="ShowListProductServlet?txtCategoryName=Bath">
                                    <span class="option-text">Bath</span>
                                </a>
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="2">			
                                <a class="sidebar-item-label_12" href="ShowListProductServlet?txtCategoryName=Bedroom">
                                    <span class="option-text">Bedroom</span>
                                </a>
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="3">			
                                <a class="sidebar-item-label_12" href="ShowListProductServlet?txtCategoryName=Living">
                                    <span class="option-text">Living</span>
                                </a>
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="4">			
                                <a class="sidebar-item-label_12" href="ShowListProductServlet?txtCategoryName=Dining">
                                    <span class="option-text">Dining</span>
                                </a>
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="5">			
                                <a class="sidebar-item-label_12" href="ShowListProductServlet?txtCategoryName=Outdoor">
                    ...
                    <div class="sidebar-body">
                        ...
                        <ul id="filterblock">
                            <li class="sidebar-item" compid="opt" posid="0">			
                                <input id="check1" type="checkbox" name="check" value="1" class="category">
                                <span class="option-text" for="check1">Dưới 1 Triệu</span>                 
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="1">
                                <input id="check1" type="checkbox" name="check" value="2" class="category">
                                <span class="option-text" for="check1">1-2 Triệu</span>                                 
                            </li>						
                            <li class="sidebar-item" compid="opt" posid="2">
                                <input id="check1" type="checkbox" name="check" value="3" class="category">
                                <span class="option-text" for="check1">2-5 Triệu</span>   
                            </li>
                            <li class="sidebar-item" compid="opt" posid="2">
                                <input id="check1" type="checkbox" name="check" value="3" class="category">
                                <span class="option-text" for="check1">Trên 5 Triệu</span>   
                            </li>
                        </ul>
                        </div>
                    </div>
                        ...
                        <div class="browseListBody">
                            <div class="content-rowxl">
                                <c:forEach var="dto" items="${listDTO}">
                                    <div class="resultblock" data-tag="${dto.styleStyleId.styleId}">
                                        <a href="ShowDetailProductServlet?txtProductID=${dto.productId}">
                                            <div class="searchresults imageArea">                            
                                                <img src="<c:out value="${dto.productPhotoCollection[0].url}"/>" width="250px" height="270px" > 
                                                <p style="color: #9f9f9f"><c:out value="${dto.productName}"/></p>
                                                <p>by <c:out value="${dto.userId.sellerName}"/></p>
                                                <h6 style="margin-top: 10px; color: #3d8901"><c:out value="${dto.price}"/>VND</h6>    
                                            </div>
