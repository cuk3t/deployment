...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>House Decor: Project Add </title>
                        ...
                        <div id="mainArea" style="margin-top: 100px;">
                            <div class="wellcome_container">                
                                ...
                                <div class="Wellcome_body_container">
                                    <form id="projectInforForm" method="post" action="ProjectServlet?action=add" class="form-horizontal my-form">

                                        <div class="rowReg" style="margin: auto">
                                            <label  class="lableInput" style="text-align: center">
                                                Project Name
                                            </label>
                                            <input required type="text" class="inputReg" id="projectName" name="projectName" placeholder="Project Name" value="">
                                        </div>
                                        <div class="rowReg" style="margin: auto">
                                            <label  class="lableInput" style="text-align: center">
                                                Address
                                            </label>
                                            <input required type="text" class="inputReg" id="address" name="address" placeholder="Address" value="">
                                        </div>
                                        <div class="rowReg" style="margin: auto">
                                            <label  class="lableInput" style="text-align: center">
                                                Cost
                                            </label>
                                            <input required type="number" class="inputReg" id="cost" name="cost" placeholder="Cost" value="" min="0">
                                        </div>
                                        <div class="rowReg" style="margin: auto">
                                            <label  class="lableInput" style="text-align: center">
                                                Website
                                            </label>
                                            <input required type="text" class="inputReg" id="website" name="website" placeholder="Website" value="">
                                        </div>
                                        <div class="rowReg" style="margin: auto">
                                            <label  class="lableInput" style="text-align: center">
                                                Year
                                            </label>
                                            <input required type="number" class="inputReg" id="year" name="year" placeholder="Year" value="">
                                        </div>
                                        <div class="rowReg" style="margin: auto;">
                                            <label  class="lableInput" style="text-align: center">
                                                Keywords
                                            </label>
                                            <input required type="text" class="inputReg" id="keywords" name="keywords" placeholder="Keywords" value="">
                                        </div>  
                                        <div class="rowReg" style="margin: auto; margin-top: 5px;">
                                            <input required type="submit" class="inputReg" value="Next">
                                        </div>  
                                    </form>
                                </div>
                            </div>
