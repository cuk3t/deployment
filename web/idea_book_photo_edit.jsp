...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>House Decor: Edit Idea Book Photo</title>
                    ...
                    <div class="hz-main-contents">
                        <div id="mainArea" style="margin-top: 100px;">
                            <div class="wellcome_container">                
                                ...
                                <%
                                    IdeaBookPhoto ideaBookPhoto = (IdeaBookPhoto) request.getAttribute("ideaBookPhoto");
                                    List<Style> styles = (List<Style>) request.getAttribute("styles");
                                    List<Category> categories = (List<Category>) request.getAttribute("categories");
                                %>
                                <div class="Wellcome_body_container">
                                    <form id="ideaBookPhotoForm" method="post" action="IdeaBookPhotoServlet?action=edit" class="form-horizontal my-form" enctype="multipart/form-data">
                                        <input type="hidden" id="id" name="id" value="<%=ideaBookPhoto.getPhotoId()%>">
                                            <input type="hidden" id="projectId" name="projectId" value="<%=ideaBookPhoto.getProjectId().getProjectId()%>">
                                                <div class="rowReg" style="margin: auto">
                                                    <label  class="lableInput" style="text-align: center">
                                                        Title
                                                    </label>
                                                    <input required type="text" class="inputReg" id="title" name="title" placeholder="Title" value="${ideaBookPhoto.getTilte()}">
                                                </div>
                                                <div class="rowReg" style="margin: auto">
                                                    ...
                                                    <div></div>
                                                    <textarea id="description" name="description" placeholder="Description" cols="48" rows="6" value="${ideaBookPhoto.getDescription()}"></textarea>
                                                </div> 
                                                <div class="rowReg" style="margin: auto">
                                                    <label  class="lableInput" style="text-align: center">
                                                        Category
                                                    ...
                                                    <br>
                                                        <select id="categoryId" name="categoryId"  style="width: 100%">
                                                            ...
                                                            <%if (category == ideaBookPhoto.getCategoryId()) {%>
                                                            <option value="<%=category.getCategoryId()%>" selected="true"><%=category.getCategoryName()%></option>
                                                            <%} else {%>
                                                ...
                                                <div class="rowReg" style="margin: auto">
                                                    ...
                                                    <br>
                                                        <select id="styleId" name="styleId"  style="width: 100%">
                                                            ...
                                                            <%if (styleId == ideaBookPhoto.getStyleId()) {%>
                                                            <option value="<%=styleId.getStyleId()%>" selected="true"><%=styleId.getName()%></option>
                                                            <%} else {%>
                                                ...
                                                <div class="rowReg" style="margin: auto">
                                                    ...
                                                    <img src="${ideaBookPhoto.getUrl()}" height="150px;" width="auto">
                                                        <input type="file" id="image" name="image" accept="image/*" style="margin-top: 10px;">
                                                            ...
                                                            <div class="rowReg" style="margin: auto; margin-top: 10px;">
                                                                <input required type="submit" class="inputReg" value="Cancel" onclick="location.href='ProjectServlet?action=edit&id=${ideaBookPhoto.projectId.projectId}'">
                                                            </div>
