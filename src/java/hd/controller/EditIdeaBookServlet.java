 ...
 * @author cuk3t
 */
public class EditIdeaBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String txtDescription = request.getParameter("txtDes");
            ...
            ideaBookDao.updateDescriptionIdeabook(txtIdeaBookID, txtDescription);
