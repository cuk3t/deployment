 ...
 * @author cuk3t
 */
public class EditIdeaBookPhotoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String txtDescriptionPhoto = request.getParameter("txtDescription");
            ...
            PhotoDao.updateIdeaBookPhotoRefPK(txtIdeaBookID,txtPhotoID, txtDescriptionPhoto);
