 ...
 * @author cuk3t
 */
public class MyIdeaBookDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            IdeaBook dto = ideaBookdao.getMyIdeaBookByID(ideaBookID);
//            List<IdeaBookPhoto> listPhoto = photoDAO.getListPhotoInIdeaBook(ideaBookID);
            
            request.setAttribute("dto", dto);
//            request.setAttribute("listPhoto", listPhoto);
            request.getRequestDispatcher("editIdeaBook.jsp").forward(request, response);
        }
    }
