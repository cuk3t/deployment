 ...
 * @author cuk3t
 */
public class ViewOverServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Professional dto = dao.getProsByID(id);
            request.setAttribute("Infodto", dto);
            ProjectDAO prosDao = new ProjectDAO();
            List<ProjectDTO> listDTO = prosDao.showListProjectOfPros(id);
